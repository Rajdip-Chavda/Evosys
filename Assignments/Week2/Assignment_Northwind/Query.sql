...
-- Q8 Sales by Year for each order.
    ...
    (
        ...
        AND a.ShippedDate BETWEEN to_date('24/12/1996', 'DD/MM/YYYY') AND to_date('30/09/1997', 'DD/MM/YYYY')
...
-- Q9 Get Employee sales by country names
    ...
    WHERE b.ShippedDate BETWEEN to_date('24/12/1996', 'DD/MM/YYYY') AND to_date('30/09/1997', 'DD/MM/YYYY')
